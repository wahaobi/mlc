    ...
    function DetectCoinData(finishedCallback) {
        ...
        _this.daemon.batchCmd(batchRpcCalls, function (error, results) {
            ...
            if (options.coin.disablecb) {
              ...
              console.log(pubkey);
              _this.daemon.cmd('setpubkey', [pubkey], function (resultkey) {
                if (resultkey.error) {
                    emitErrorLog('setpubkey call failed for daemon instance ' +
                        result.instance.index + ' with error ' + JSON.stringify(result.error));
                } else {
                    console.log(resultkey);
                    console.log(rpcResults.validateaddress);
                    var resposnevar = resultkey.response;
                    console.log(resposnevar.address);
